...
public class EaglercraftVersion {
	...
	public static final String projectForkName = "Treasure Client";
	public static final String projectForkVersion = "1.0.0";
	public static final String projectForkVendor = "PLX";
	...
	public static final String localStorageNamespace = "_treasure_client_1.12";
