...
public class GameSettings {
	...
	public KeyBinding keyBindEaglerTone = new KeyBinding("key.eaglertone", KeyboardConstants.KEY_LBRACKET, "key.categories.misc");
	...
	public GameSettings(Minecraft mcIn) {
		this.keyBindings = (KeyBinding[]) ArrayUtils.addAll(
				new KeyBinding[] { this.keyBindAttack, this.keyBindUseItem, this.keyBindForward, this.keyBindLeft,
						...
						this.keyBindPickBlock, this.keyBindCommand, this.keyBindEaglerTone, this.keyBindScreenshot,
