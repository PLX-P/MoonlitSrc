...
public class Minecraft implements IThreadListener {
	...
	private void runTickKeyboard() throws IOException {
		...
		net.eaglercraft.eaglertone.EaglerToneClientAdapter12.tick(this);
	}
	...
	private void processKeyBinds() {
		while (this.gameSettings.keyBindEaglerTone.isPressed()) {
			if (net.eaglercraft.eaglertone.EaglerToneClientAdapter12.engine().isEnabled()) {
				net.eaglercraft.eaglertone.EaglerToneClientAdapter12.disable();
			} else {
				net.eaglercraft.eaglertone.EaglerToneClientAdapter12.enable();
			}
		}
